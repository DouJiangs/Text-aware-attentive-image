...
def model_opts(parser):
    ...
    group.add_argument('-src_word_vec_size', type=int, default=128,#512,
                       help='Word embedding size for src.')
    group.add_argument('-tgt_word_vec_size', type=int, default=128,#512,
    ...
    group.add_argument('-rnn_size', type=int, default=256,#512,
    ...
    group.add_argument('-bi_attention', type=int, default=1,
                       help="""Using bi-attention""")
    group.add_argument('-co_attention', type=int, default=1,
                       help="""Using co-attention""")
    ...
    #options for multi-modal
def train_mm_opts(parser):
    parser.add_argument('-image_feat_type', type=str, default=None,
                       help='image_feat_type to extract image feature.   which is the flag of multi-modal')

    parser.add_argument('-img_train_feat_1', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    parser.add_argument('-img_train_feat_2', default=None, #required=True,
                        help="""Path to hdf5 file containing validation image features""")
    parser.add_argument('-img_train_feat_3', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    parser.add_argument('-img_train_feat_4', default=None, #required=True,
                        help="""Path to hdf5 file containing validation image features""")
    parser.add_argument('-img_train_feat_5', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")

    parser.add_argument('-img_valid_feat_1', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    parser.add_argument('-img_valid_feat_2', default=None, #required=True,
                        help="""Path to hdf5 file containing validation image features""")
    parser.add_argument('-img_valid_feat_3', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    parser.add_argument('-img_valid_feat_4', default=None, #required=True,
                        help="""Path to hdf5 file containing validation image features""")
    parser.add_argument('-img_valid_feat_5', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    ...
    parser.add_argument('-language',type=str,default='en_de')

def translate_mm_opts(parser):
    parser.add_argument('-img_test_feat_1',default=None, #required=True,
                        help="""Path to hdf5 file containing test image features""")
    parser.add_argument('-img_test_feat_2',default=None, #required=True,
                        help="""Path to hdf5 file containing test image features""")
    parser.add_argument('-img_test_feat_3',default=None, #required=True,
                        help="""Path to hdf5 file containing test image features""")
    parser.add_argument('-img_test_feat_4',default=None, #required=True,
                        help="""Path to hdf5 file containing test image features""")
    parser.add_argument('-img_test_feat_5',default=None, #required=True,
                        help="""Path to hdf5 file containing test image features""")
    
    parser.add_argument('-image_num_test', default=5,type=int,
                        help="""how many image""")
...
def train_opts(parser):
    ...
    group.add_argument('-beam_size',  type=int, default=12,
                       help='Beam size')
    ...
    group.add_argument('-max_generator_batches', type=int, default=64,
    ...
    group.add_argument('-embedding_dropout', type=float, default=0.3,
                       help="Dropout probability; applied in embedding.")
...
def translate_opts(parser):
    ...
    group.add_argument('-stepwise_penalty', action='store_false',#'store_true',
