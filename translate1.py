...
def main():
    ...
    if opt.image_feat_type is not None:
        if opt.img_test_feat_1 is None : 
        ...
        test_file_1 = tables.open_file(opt.img_test_feat_1, mode='r')
        test_file_2 = tables.open_file(opt.img_test_feat_2, mode='r')
        test_file_3 = tables.open_file(opt.img_test_feat_3, mode='r')
        test_file_4 = tables.open_file(opt.img_test_feat_4, mode='r')
        test_file_5 = tables.open_file(opt.img_test_feat_5, mode='r')

        img_test_feat_1 = test_file_1.root.local_feats[:]
        img_test_feat_2 = test_file_2.root.local_feats[:]
        img_test_feat_3 = test_file_3.root.local_feats[:]
        img_test_feat_4 = test_file_4.root.local_feats[:]
        img_test_feat_5 = test_file_5.root.local_feats[:]

        test_img_feats = np.stack([img_test_feat_1,img_test_feat_2,img_test_feat_3,img_test_feat_4,img_test_feat_5],axis=1)
        
        image_num = opt.image_num_test
        test_img_feats = test_img_feats[:,:image_num,:]
        print("test_img_feats",test_img_feats.shape)
